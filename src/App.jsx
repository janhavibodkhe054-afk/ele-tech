...
function App() {
  ...
  return (
    <Router>
      ...
      {/* PAGE CONTENT SPACING (VERY IMPORTANT) */}
      <main className="pt-[90px] md:pt-[120px]">
        ...
        <Routes>
          ...
          <Route path="/services/mechanical-utility-piping" element={<MechanicalUtilityPiping />} />
          <Route path="/services/assembly-line-installation" element={<AssemblyLineInstallation />} />
          <Route path="/services/electrical-it-infrastructure" element={<ElectricalITInfrastructure />} />
          <Route path="/services/spare-parts-procurement" element={<SpareParts />} />
